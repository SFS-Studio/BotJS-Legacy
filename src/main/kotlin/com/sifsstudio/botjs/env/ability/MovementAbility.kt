...
class MovementAbility : AbilityBase() {
    ...
    companion object {
        ...
        class MovementTask(val endX: Double, val endZ: Double): TaskBase<MoveResult>() {
            override fun tick() {
        ...
        class DirectionalMovementTask(direction: Direction, var distance: Double): TaskBase<MoveResult>() {
